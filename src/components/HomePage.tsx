        ...
        {user ? (
          ...
          <div className="hero">
            ...
            <div className="actions">
              ...
              <a href="/auth/login/force" className="btn btn-ghost">Force re-auth</a>
              <a href="/auth/login/consent" className="btn btn-ghost">Re-consent</a>
            </div>
          </div>
        )}
        ...
        <div className="card card-table">
          <table className="routes-table">
            ...
            <tbody>
              {routes.map((r) => (
                <tr key={r.path}>
                  <td><span className={`route-tag ${r.method.toLowerCase()}`}>{r.method}</span></td>
